/**
 * Menu contains a menu of food, orders and combos.
 */
...
class Menu {
    ...
    /**
     * Add orders.
     * If food does not have the id, the combo should have it.
     * @param n id of order.
     */
    ...
    /**
     * Prints burger, snack, then drink.
     * @param list list of food to print from.
     */

    static void orderedPrint(ArrayList<Food> list) {
        for (Food food: list) {
            if (food.getType().equals("Burger")) {
                System.out.println("#" + food.getid() + " " + food.getType() + 
    ...
    /**
     * Keeps track of total amount and prints orders.
     * Prints in sequence of being added to orders.
     */
